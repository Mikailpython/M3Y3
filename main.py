...
@bot.message_handler(commands=['start']) # Для того чтобы начать использовать бота
...
@bot.message_handler(commands=['info']) # Для того чтобы получить информацию о комманды
def info(message):
...
/skills - используй для своего пройекта чтобы выбрать навык
/projects - используй для вывода своего пройекта
/delete - используй для удаления своего пройекта
/update_projects - используй для обновление своего пройекта

Также ты можешь ввести имя проекта и узнать информацию о нем!""")
    

@bot.message_handler(commands=['new_project']) # Для создание проекта 
...
@bot.message_handler(commands=['skills']) # Для того чтобы выбрать навык для своего проекта
...
@bot.message_handler(commands=['projects']) # Для вывода своего проекта
...
@bot.message_handler(commands=['delete']) # Для удаления своего проекта
...
@bot.message_handler(commands=['update_projects']) # Для того чтобы обновить сцой проект
